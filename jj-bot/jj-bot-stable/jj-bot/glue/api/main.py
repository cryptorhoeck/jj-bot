...
async def get_live_market_data():
    ...
    try:
        ...
        url = "https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,binancecoin,cardano,dogecoin&vs_currencies=usd&include_24hr_change=true"
        ...
        return {
            "BTCUSDT": {"price": 45000, "change_24h": 0},
            "ETHUSDT": {"price": 2500, "change_24h": 0},
            "BNBUSDT": {"price": 300, "change_24h": 0},
            "error": str(e)
        }
